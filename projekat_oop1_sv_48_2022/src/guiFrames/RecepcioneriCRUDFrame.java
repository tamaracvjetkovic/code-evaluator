...
import guiCRUDFrames.RecepcionerFrameAdd;
import guiCRUDFrames.RecepcionerFrameEdit;
...
public class RecepcioneriCRUDFrame extends JFrame {
	...
	public RecepcioneriCRUDFrame(ManageAll manageAll, String nazivSalona, Menadzer m) {
	...
	private void initialize() {
		...
		setTitle(" " + nazivSalona + " | " + m.getIme() + " " + m.getPrezime() + " - RECEPCIONERI OPCIJE");
		setSize(880, 410);
		setResizable(false);
		...
		tabela = new JTable(new RecepcioneriCRUDTableModel(manageAll));		
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e2) {
				RecepcionerFrameAdd recepcionerFrameAdd = new RecepcionerFrameAdd(manageAll, RecepcioneriCRUDFrame.this, tabela);
				recepcionerFrameAdd.toString();
				return;
			}
		});
		...
		btnEdit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e2) {		
				if (tabela.getSelectedRow() != -1) {
					...
					Recepcioner r2 = recepcioneriMng.pronadjiRecepcioneraPoId(id);
					if (r2 != null) {
						RecepcionerFrameEdit recepcionerFrameEdit = new RecepcionerFrameEdit(manageAll, RecepcioneriCRUDFrame.this, r2, tabela);
						recepcionerFrameEdit.toString();
						return;
					} else {
		...
		center(RecepcioneriCRUDFrame.this, 1);
		setVisible(true);
	}
	
	
	public void refreshData() {
		RecepcioneriCRUDTableModel sm = (RecepcioneriCRUDTableModel)this.tabela.getModel();
