...
import guiFrames.RecepcioneriCRUDFrame;
import guiTableModels.RecepcioneriCRUDTableModel;
...
public class RecepcionerFrameEdit extends JDialog {
	...
	private RecepcioneriCRUDFrame recepcioneriCRUDFrame;
	private Recepcioner r;
	private JTable tabela;
	
	
	public RecepcionerFrameEdit(ManageAll manageAll, RecepcioneriCRUDFrame recepcioneriCRUDFrame, Recepcioner r, JTable tabela) {
		...
		this.okLozinka = true;
		this.recepcioneriCRUDFrame = recepcioneriCRUDFrame;
		this.r = r;
		this.tabela = tabela;
		initialize();
	}
	...
	private void initialize() {
		...
		addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
            	((RecepcioneriCRUDFrame) recepcioneriCRUDFrame).refreshData();
            	recepcioneriCRUDFrame.validate();
            	recepcioneriCRUDFrame.repaint();
            }
        });
		...
		prezimeInput.setText(r.getPrezime());
		...
		telefonInput.setText(r.getTelefon());
		...
		adresaInput.setText(r.getAdresa());
		...
		korisnickoInput.setText(r.getKorisnickoIme());
		...
		lozinkaInput.setText(r.getLozinka());
        ...
        list.setSelectedItem(r.getNivoStrucneSpreme());
        ...
        bonusInput.setValue(r.getBonus());
        ...
        plataInput.setValue(r.getPlata());
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (okIme == false || okIme == false || okPrezime == false || okPol == false || okTelefon == false || okAdresa == false || okKorisnicko == false || okLozinka == false) {
					...
					int id = r.getId();
					RecepcioneriCRUDTableModel sm = (RecepcioneriCRUDTableModel) tabela.getModel();
					sm.edit(id, ime, prezime, pol, telefon, adresa, korisnicko, lozinka, nivoStrucneSpreme, staz, bonus, plata);
		...
		center(RecepcionerFrameEdit.this, 1);
		setVisible(true);	
	}
