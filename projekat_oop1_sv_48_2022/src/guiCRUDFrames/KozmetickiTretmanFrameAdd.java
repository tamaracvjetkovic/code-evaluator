...
public class KozmetickiTretmanFrameAdd extends JDialog {
	...
	public KozmetickiTretmanFrameAdd(ManageAll manageAll, KozmetickiTretmaniCRUDFrame kozmetickiTretmaniCRUDFrame, JTable tabela) {
	...
	private void initialize() {
		...
		JLabel addMenadzerTekst = new JLabel("<html> <p style = 'font-size: 13px; font-weight: 500;'> ADD TRETMAN </p> </html>");
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (okNaziv == false) {
					...
					KozmetickiTretman kt2 = new KozmetickiTretman(id, naziv, false);	
					KozmetickiTretmaniCRUDTableModel sm = (KozmetickiTretmaniCRUDTableModel) tabela.getModel();
					sm.add(kt2);
					JOptionPane.showMessageDialog(null, "USPEŠNO DODAN NOVI TRETMAN!");
					((KozmetickiTretmaniCRUDFrame) kozmetickiTretmaniCRUDFrame).refreshData();
					dispose();
				}
			}
		...
		center(KozmetickiTretmanFrameAdd.this, 1);
		setVisible(true);	
	}
