...
public class KozmetickaUslugaFrameAdd extends JDialog {
	...
	public KozmetickaUslugaFrameAdd(ManageAll manageAll, KozmetickeUslugeCRUDFrame kozmetickeUslugeCRUDFrame, JTable tabela) {
	...
	private void initialize() {
		...
		JLabel addMenadzerTekst = new JLabel("<html> <p style = 'font-size: 13px; font-weight: 500;'> ADD USLUGA </p> </html>");
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (okNaziv == false || okTretman == false) {
					...
					KozmetickaUsluga ku2 = new KozmetickaUsluga(id, naziv, cena, trajanje, id2, false);	
					KozmetickeUslugeCRUDTableModel sm = (KozmetickeUslugeCRUDTableModel) tabela.getModel();
					sm.add(ku2);
					JOptionPane.showMessageDialog(null, "USPEŠNO DODANA NOVA USLUGA!");
					((KozmetickeUslugeCRUDFrame) kozmetickeUslugeCRUDFrame).refreshData();
					kozmetickeUslugeCRUDFrame.validate();
					kozmetickeUslugeCRUDFrame.repaint();
					dispose();
		...
		center(KozmetickaUslugaFrameAdd.this, 1);
		setVisible(true);	
	}
