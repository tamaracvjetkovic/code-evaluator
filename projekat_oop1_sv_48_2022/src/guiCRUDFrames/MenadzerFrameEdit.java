...
public class MenadzerFrameEdit extends JDialog {
	...
	public MenadzerFrameEdit(ManageAll manageAll, MenadzeriCRUDFrame menadzeriCRUDFrame, Menadzer m, JTable tabela) {
	...
	private void initialize() {
		...
		JLabel editMenadzerTekst = new JLabel("<html> <p style = 'font-size: 13px; font-weight: 500;'> EDIT MENADŽER </p> </html>");
		editMenadzerTekst.setBackground(getBackground());
		...
		prezimeInput.setText(m.getPrezime());
		...
		telefonInput.setText(m.getTelefon());
		...
		adresaInput.setText(m.getAdresa());
		...
		korisnickoInput.setText(m.getKorisnickoIme());
		...
		JTextField lozinkaInput = new JTextField(20);
		lozinkaInput.setMargin(new Insets(2, 4, 2, 4));
		lozinkaInput.setFont(font1);
		lozinkaInput.setText(m.getLozinka());
		...
		add(editMenadzerTekst, centerSpanXWrapCC);
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (okIme == false || okIme == false || okPrezime == false || okPol == false || okTelefon == false || okAdresa == false || okKorisnicko == false || okLozinka == false) {
					...
					sm.edit(m, ime, prezime, pol, telefon, adresa, korisnicko, lozinka, false);
					menadzeriMng.edit(m, ime, prezime, pol, telefon, adresa, korisnicko, lozinka, false);
					JOptionPane.showMessageDialog(null, "USPEŠNO IZMENJEN MENADŽER!");
					((MenadzeriCRUDFrame) menadzeriCRUDFrame).refreshData();
					menadzeriCRUDFrame.validate();
					menadzeriCRUDFrame.repaint();
					dispose();
		...
		center(MenadzerFrameEdit.this, 1);
		setVisible(true);	
	}
